...
This stage configures a department file share on `AD-SRV01` and tests access from a domain-joined Windows 10 client.

The goal is to connect the Active Directory structure to a practical support task: giving a department user access to a shared folder through group membership and Windows permissions.
